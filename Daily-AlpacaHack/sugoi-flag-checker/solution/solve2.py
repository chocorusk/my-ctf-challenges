...
s_box = list(data[sbox_off:sbox_off+256])
inv_s_box = list(data[rsbox_off:rsbox_off+256])
key = data[key_off:key_off+16]
ciphertext = data[ct_off:ct_off+32]
...
for i in range(0, len(ciphertext), 16):
    flag += aes.decrypt_block(ciphertext[i:i+16])
